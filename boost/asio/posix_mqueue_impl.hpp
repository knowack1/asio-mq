/*
 * posix_mqueue_impl.hpp
 *
 *  Created on: Apr 24, 2014
 *      Author: knowacki
 */

#ifndef POSIX_MQUEUE_IMPL_HPP_
#define POSIX_MQUEUE_IMPL_HPP_
...
public:
    ...
    void open(const char* name, int flags, boost::system::error_code& ec)
    {
        ...
        if (flags & O_CREAT)
        {
            d_ = mq_open(name, O_CREAT | O_RDWR,
